...
/**
 * Esta función busca todos los libros segun los parametros que le pongas.
 ...
 */
function buscarLibrosAdmin($titulo = null, $autor = null, $isbn = null, $editorial = null):array {
    try {
        $mysqli = establecerConexion();
        
        // Comenzamos construyendo la consulta base
        $sql = "SELECT * FROM libros WHERE 1 = 1"; // Siempre verdadero para agregar condiciones dinámicamente
